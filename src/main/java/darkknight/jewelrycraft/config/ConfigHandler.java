...
public class ConfigHandler
{
    ...
    public static final String[] categories = {"Timers", "Village Generation", "Misc", "World Generation", "Curses", "Potions"};
    ...
    private void syncConfigs()
    {
        ...
        STUN_ID = config.getInt("Stun Potion ID", categories[5], Potion.potionTypes.length, 0, Integer.MAX_VALUE, "THis is the id of the stun potion effect");
